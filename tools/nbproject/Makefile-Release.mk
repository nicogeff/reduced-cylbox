...
${OBJECTDIR}/src/tools_chainedList.o: src/tools_chainedList.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_chainedList.o src/tools_chainedList.c

${OBJECTDIR}/src/tools_console.o: src/tools_console.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_console.o src/tools_console.c

${OBJECTDIR}/src/tools_conversion.o: src/tools_conversion.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_conversion.o src/tools_conversion.c

${OBJECTDIR}/src/tools_fileManip.o: src/tools_fileManip.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_fileManip.o src/tools_fileManip.c

${OBJECTDIR}/src/tools_parserJson.o: src/tools_parserJson.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_parserJson.o src/tools_parserJson.c

${OBJECTDIR}/src/tools_parserJsonTools.o: src/tools_parserJsonTools.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_parserJsonTools.o src/tools_parserJsonTools.c

${OBJECTDIR}/src/tools_strManip.o: src/tools_strManip.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_strManip.o src/tools_strManip.c

${OBJECTDIR}/src/tools_timeManip.o: src/tools_timeManip.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_timeManip.o src/tools_timeManip.c

${OBJECTDIR}/src/tools_trace.o: src/tools_trace.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_trace.o src/tools_trace.c
...
${TESTDIR}/tests/tools_chainedList_tests/tools_chainedList_main.o: tests/tools_chainedList_tests/tools_chainedList_main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_chainedList_tests/tools_chainedList_main.o tests/tools_chainedList_tests/tools_chainedList_main.c


${TESTDIR}/tests/tools_chainedList_tests/tools_chainedList_tests.o: tests/tools_chainedList_tests/tools_chainedList_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/tools_chainedList_tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_chainedList_tests/tools_chainedList_tests.o tests/tools_chainedList_tests/tools_chainedList_tests.c
...
${TESTDIR}/tests/tools_parserJson_tests/tools_parserJsonTools_tests.o: tests/tools_parserJson_tests/tools_parserJsonTools_tests.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_parserJson_tests/tools_parserJsonTools_tests.o tests/tools_parserJson_tests/tools_parserJsonTools_tests.c


${TESTDIR}/tests/tools_parserJson_tests/tools_parserJson_main.o: tests/tools_parserJson_tests/tools_parserJson_main.c 
	${MKDIR} -p ${TESTDIR}/tests/tools_parserJson_tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_parserJson_tests/tools_parserJson_main.o tests/tools_parserJson_tests/tools_parserJson_main.c


${TESTDIR}/tests/tools_parserJson_tests/tools_parserJson_tests.o: tests/tools_parserJson_tests/tools_parserJson_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/tools_parserJson_tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_parserJson_tests/tools_parserJson_tests.o tests/tools_parserJson_tests/tools_parserJson_tests.c
...
${TESTDIR}/tests/tools_strManip_tests/tools_strManip_tests.o: tests/tools_strManip_tests/tools_strManip_tests.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/tools_strManip_tests/tools_strManip_tests.o tests/tools_strManip_tests/tools_strManip_tests.c
...
${OBJECTDIR}/src/tools_chainedList_nomain.o: ${OBJECTDIR}/src/tools_chainedList.o src/tools_chainedList.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_chainedList_nomain.o src/tools_chainedList.c;\
	else  \
...
${OBJECTDIR}/src/tools_console_nomain.o: ${OBJECTDIR}/src/tools_console.o src/tools_console.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_console_nomain.o src/tools_console.c;\
	else  \
...
${OBJECTDIR}/src/tools_conversion_nomain.o: ${OBJECTDIR}/src/tools_conversion.o src/tools_conversion.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_conversion_nomain.o src/tools_conversion.c;\
	else  \
...
${OBJECTDIR}/src/tools_fileManip_nomain.o: ${OBJECTDIR}/src/tools_fileManip.o src/tools_fileManip.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_fileManip_nomain.o src/tools_fileManip.c;\
	else  \
...
${OBJECTDIR}/src/tools_parserJson_nomain.o: ${OBJECTDIR}/src/tools_parserJson.o src/tools_parserJson.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_parserJson_nomain.o src/tools_parserJson.c;\
	else  \
...
${OBJECTDIR}/src/tools_parserJsonTools_nomain.o: ${OBJECTDIR}/src/tools_parserJsonTools.o src/tools_parserJsonTools.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_parserJsonTools_nomain.o src/tools_parserJsonTools.c;\
	else  \
...
${OBJECTDIR}/src/tools_strManip_nomain.o: ${OBJECTDIR}/src/tools_strManip.o src/tools_strManip.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_strManip_nomain.o src/tools_strManip.c;\
	else  \
...
${OBJECTDIR}/src/tools_timeManip_nomain.o: ${OBJECTDIR}/src/tools_timeManip.o src/tools_timeManip.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_timeManip_nomain.o src/tools_timeManip.c;\
	else  \
...
${OBJECTDIR}/src/tools_trace_nomain.o: ${OBJECTDIR}/src/tools_trace.o src/tools_trace.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Iinc -I../nal/inc -I../nal/src/stor -I../nal/plf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools_trace_nomain.o src/tools_trace.c;\
	else  \
