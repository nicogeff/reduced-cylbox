...
${OBJECTDIR}/src/auth_authorizations.o: src/auth_authorizations.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_authorizations.o src/auth_authorizations.c

${OBJECTDIR}/src/auth_global_rbac.o: src/auth_global_rbac.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_global_rbac.o src/auth_global_rbac.c

${OBJECTDIR}/src/auth_mgt.o: src/auth_mgt.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_mgt.o src/auth_mgt.c

${OBJECTDIR}/src/auth_roles.o: src/auth_roles.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_roles.o src/auth_roles.c

${OBJECTDIR}/src/auth_sessions.o: src/auth_sessions.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_sessions.o src/auth_sessions.c

${OBJECTDIR}/src/auth_users.o: src/auth_users.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_users.o src/auth_users.c
...
${OBJECTDIR}/src/auth_mgt_nomain.o: ${OBJECTDIR}/src/auth_mgt.o src/auth_mgt.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -I../common/inc -I../crypto-al/plf/linux/inc -I../crypto-al/inc -I../entity-mgt/inc -I../nal/src/ip -I../nal/src/libc -I../nal/src/rtos -I../nal/inc -I../nal/plf/linux/inc -I../tools/inc -I../log_monitor/inc -I../3-party/mbedtls/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/auth_mgt_nomain.o src/auth_mgt.c;\
	else  \
