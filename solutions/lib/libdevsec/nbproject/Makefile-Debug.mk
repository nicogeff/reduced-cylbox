...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../entity-mgt/dist/Debug/GNU-Linux/libentity-mgt.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../web-server/dist/Debug/GNU-Linux/libweb-server.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../auth-rbac/dist/Debug/GNU-Linux/libauth-rbac.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../crypto-al/dist/Debug/GNU-Linux/libcrypto-al.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../tools/dist/Debug/GNU-Linux/libtools.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdevsec.${CND_DLIB_EXT}: ../../../nal/dist/Debug/GNU-Linux/libnal.a
...
${OBJECTDIR}/lib_main.o: lib_main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../../../common/inc -I../../../tools/inc -I../../../nal/inc -I../../../nal/plf/linux/inc `pkg-config --cflags libgpiod` `pkg-config --cflags openssl`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib_main.o lib_main.c
