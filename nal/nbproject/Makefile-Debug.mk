...
${OBJECTDIR}/src/ip/nal_ip_bsd_4_3.o: src/ip/nal_ip_bsd_4_3.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ip/nal_ip_bsd_4_3.o src/ip/nal_ip_bsd_4_3.c

${OBJECTDIR}/src/libc/nal_libc_posix.o: src/libc/nal_libc_posix.c
	${MKDIR} -p ${OBJECTDIR}/src/libc
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libc/nal_libc_posix.o src/libc/nal_libc_posix.c

${OBJECTDIR}/src/mem/nal_mem_alloc.o: src/mem/nal_mem_alloc.c
	${MKDIR} -p ${OBJECTDIR}/src/mem
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mem/nal_mem_alloc.o src/mem/nal_mem_alloc.c

${OBJECTDIR}/src/net/nal_net_linux.o: src/net/nal_net_linux.c
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/nal_net_linux.o src/net/nal_net_linux.c

${OBJECTDIR}/src/rtos/nal_rtos_posix.o: src/rtos/nal_rtos_posix.c
	${MKDIR} -p ${OBJECTDIR}/src/rtos
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/rtos/nal_rtos_posix.o src/rtos/nal_rtos_posix.c

${OBJECTDIR}/src/stor/nal_stor_stdio.o: src/stor/nal_stor_stdio.c
	${MKDIR} -p ${OBJECTDIR}/src/stor
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stor/nal_stor_stdio.o src/stor/nal_stor_stdio.c
...
${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/nal_libc_tests/nal_libc_main.o ${TESTDIR}/tests/nal_libc_tests/nal_libc_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.c} -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS}   -Ldist/Debug/GNU-Linux -lpthread -lrt -lcunit 
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/nal_net_tests/nal_net_main.o ${TESTDIR}/tests/nal_net_tests/nal_net_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.c} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}   -Ldist/Debug/GNU-Linux -lpthread -lrt -lcunit 
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_main.o ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_mutexes_tests.o ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_semaphores_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.c} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -Ldist/Debug/GNU-Linux -lpthread -lrt -lcunit 


${TESTDIR}/tests/nal_libc_tests/nal_libc_main.o: tests/nal_libc_tests/nal_libc_main.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_libc_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_libc_tests/nal_libc_main.o tests/nal_libc_tests/nal_libc_main.c


${TESTDIR}/tests/nal_libc_tests/nal_libc_tests.o: tests/nal_libc_tests/nal_libc_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_libc_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_libc_tests/nal_libc_tests.o tests/nal_libc_tests/nal_libc_tests.c


${TESTDIR}/tests/nal_net_tests/nal_net_main.o: tests/nal_net_tests/nal_net_main.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_net_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_net_tests/nal_net_main.o tests/nal_net_tests/nal_net_main.c


${TESTDIR}/tests/nal_net_tests/nal_net_tests.o: tests/nal_net_tests/nal_net_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_net_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_net_tests/nal_net_tests.o tests/nal_net_tests/nal_net_tests.c


${TESTDIR}/tests/nal_rtos_tests/nal_rtos_main.o: tests/nal_rtos_tests/nal_rtos_main.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_rtos_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_main.o tests/nal_rtos_tests/nal_rtos_main.c


${TESTDIR}/tests/nal_rtos_tests/nal_rtos_mutexes_tests.o: tests/nal_rtos_tests/nal_rtos_mutexes_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_rtos_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_mutexes_tests.o tests/nal_rtos_tests/nal_rtos_mutexes_tests.c


${TESTDIR}/tests/nal_rtos_tests/nal_rtos_semaphores_tests.o: tests/nal_rtos_tests/nal_rtos_semaphores_tests.c 
	${MKDIR} -p ${TESTDIR}/tests/nal_rtos_tests
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nal_rtos_tests/nal_rtos_semaphores_tests.o tests/nal_rtos_tests/nal_rtos_semaphores_tests.c
...
${OBJECTDIR}/src/ip/nal_ip_bsd_4_3_nomain.o: ${OBJECTDIR}/src/ip/nal_ip_bsd_4_3.o src/ip/nal_ip_bsd_4_3.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ip/nal_ip_bsd_4_3_nomain.o src/ip/nal_ip_bsd_4_3.c;\
	else  \
...
${OBJECTDIR}/src/libc/nal_libc_posix_nomain.o: ${OBJECTDIR}/src/libc/nal_libc_posix.o src/libc/nal_libc_posix.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libc/nal_libc_posix_nomain.o src/libc/nal_libc_posix.c;\
	else  \
...
${OBJECTDIR}/src/mem/nal_mem_alloc_nomain.o: ${OBJECTDIR}/src/mem/nal_mem_alloc.o src/mem/nal_mem_alloc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mem/nal_mem_alloc_nomain.o src/mem/nal_mem_alloc.c;\
	else  \
...
${OBJECTDIR}/src/net/nal_net_linux_nomain.o: ${OBJECTDIR}/src/net/nal_net_linux.o src/net/nal_net_linux.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net/nal_net_linux_nomain.o src/net/nal_net_linux.c;\
	else  \
...
${OBJECTDIR}/src/rtos/nal_rtos_posix_nomain.o: ${OBJECTDIR}/src/rtos/nal_rtos_posix.o src/rtos/nal_rtos_posix.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/rtos/nal_rtos_posix_nomain.o src/rtos/nal_rtos_posix.c;\
	else  \
...
${OBJECTDIR}/src/stor/nal_stor_stdio_nomain.o: ${OBJECTDIR}/src/stor/nal_stor_stdio.o src/stor/nal_stor_stdio.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinc -Isrc/ip -Isrc/libc -Isrc/mem -Isrc/net -Isrc/rtos -Isrc/stor -Iplf/linux/inc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stor/nal_stor_stdio_nomain.o src/stor/nal_stor_stdio.c;\
	else  \
